...
$_SESSION["EligiblePositinID"] = $Positionid;
    ...
    <div class="content_resize">
      ...
      <div class="mainbar">
        ...
        <div class="article" style="margin-bottom:40px;">
           ...
           <h2><span>Registered Candidates</span></h2>
		  ...
		  <table>
		  	 ...
		  	 <form method="post" action="comp_view_EligibleCandidates.php" >
				...
				<td colspan="20" style="float:right;" >
				<input type="submit" class="btnSubmit" id="btnupdate"  style="width:180px;  height:25px;" value="View Eligible Candidates"/></td>
