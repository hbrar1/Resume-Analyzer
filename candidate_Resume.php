...
$result = mysql_query("SELECT * FROM candidateexperience  WHERE candidateexperience.candidateemail='$email'");
					...
					echo "<tr><td><b>Company Name</b></td><td><b>Designation</b></td><td><b>Start_Date</b></td><td><b>End_Date</b></td><td><b>Description</b></td></tr>";
					while($row = mysql_fetch_array($result))
					{
...
$result = mysql_query("SELECT * FROM candidatecertification  WHERE candidatecertification.candidateemail='$email'");
					...
					while($row = mysql_fetch_array($result))
					{
						...
						echo "<tr><td>".$row['certificationtitle'] ."</td><td>".$row['certificationdate']."</td><td>".$row['remarks']."</td></tr>";
