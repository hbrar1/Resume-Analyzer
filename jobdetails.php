...
$result = mysql_query("SELECT * FROM positionannouncement where   positionannouncementid='$id' ");

while($row = mysql_fetch_array($result))
{


echo "<tr><td>Title  <td>".$row[1] ."</td></tr>";

echo "<tr><td>Desc </td><td>".$row[2]."</td></tr>";
echo "<tr><td>File </td><td><img src='cupload/".$row[3]."' width='30px' height='20px' /></td></tr>";
echo "<tr><td>E.Reqrd </td><td>".$row[4]."</td></tr>";
echo "<tr><td>No.OfVacancies</td> <td>".$row[5]."</td></tr>";
echo "<tr><td>SkillsReq </td><td>".$row[6]."</td></tr>";
echo "<tr><td> CertReq </td><td>".$row[7]."</td></tr>";
echo "<tr><td> QualiReq</td> <td>".$row[8]."</td></tr>";
echo "<tr><td> DistrDomicile</td> <td>".$row[9]."</td></tr>";
echo "<tr><td> gender </td><td>".$row[10]."</td></tr>";
echo "<tr><td> Preferences</td> <td>".$row[11]."</td></tr>";
echo "<tr><td> Nationality</td> <td>".$row[12]."</td></tr>";
echo "<tr><td> DateOfPost</td> <td>".$row[13]."</td></tr>";
echo "<tr><td> Closingdate</td> <td>".$row[14]."</td></tr>";

echo "<tr> <td>Apply</td> <td><a href=applyjob.php?id=".$row[0]."&c=".$row[15].">Click Here To Apply</a></td>";
